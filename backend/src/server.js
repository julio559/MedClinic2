...
/** Importante quando estiver atrás de proxy (Render, etc.) */
...
app.use(
  helmet({
    crossOriginResourcePolicy: { policy: "cross-origin" }, // permite servir imagens em <img>
  })
);
app.use(cors());
...
async function bootstrap() {
  try {
    ...
    // 5) Sobe servidor (0.0.0.0 para ambientes PaaS)
